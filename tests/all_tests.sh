...
run_all_tests() {
    ...
    echo "======================================================"
    echo ""
    ./build/tests/ptcprint_system_tests
    ...
    echo "     MEMORY TESTS"
    echo "======================================================"
    ./tests/profiling.sh memcheck ./build/tests/ptcprint_system_tests
    ...
    ./tests/profiling.sh helgrind ./build/tests/ptcprint_threading_tests
    ...
    echo "======================================================"
    echo ""
    ./build/tests/ptcprint_unit_tests
